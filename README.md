...
A live demo of the project is available at [https://bocilsmp.pages.dev](https://bocilsmp.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocil smp`)
...
1. Fork the [repository](https://github.com/puntirande/bocilsmp/fork) on GitHub.
